...
import 'kunjan_painter.dart';
import 'mascot_state.dart';

/// Kunjan, the app's baby-elephant mascot, as a reusable animated widget.
...
class KunjanMascot extends StatefulWidget {
  const KunjanMascot({super.key, required this.state, this.size = 96});

  final MascotState state;
  final double size;

  @override
  State<KunjanMascot> createState() => _KunjanMascotState();
}

class _KunjanMascotState extends State<KunjanMascot> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant KunjanMascot oldWidget) {
